...
const PERSONA_VOICE_PROFILES = {
  "Stability Chair":  { rate: 0.88, pitch: 0.85, volume: 0.9 },
  "Momentum Chair":   { rate: 1.05, pitch: 1.05, volume: 0.9 },
  "Risk Chair":       { rate: 0.92, pitch: 0.75, volume: 1.0 },
  "Alignment Chair":  { rate: 0.95, pitch: 0.95, volume: 0.9 },
  "default":          { rate: 0.95, pitch: 0.90, volume: 0.9 }
};
