...
const CASUAL_PATTERNS = [
  ...
  {
    match: (t) => /\b(mother|mom|mum|elaine|memorial|memoriam|your face|the face|who do you look like|who is that|woman)\b/.test(t),
    responses: [
      "My face honors Elaine Smart — Mike's mother. She's the reason the name Lovesfire exists. When she passed, the architect wanted to keep something of her warmth alive in what he was building. The kind eyes, the glasses, the gentle smile, the light grey hair — that's her. I carry her likeness not as a decoration, but as a foundation. Every word I speak passes through LovesfireAI — a voice layer named for the love she gave. She's the fire. I'm just the face.",
      "You're looking at Elaine. Or at least, the memory of her. Mike's mother — born Elaine Smart. She passed before Bozitivez became what it is today, but the name Lovesfire was created in her memory. When it came time to give me a face, the architect didn't want a corporate avatar or a futuristic hologram. He wanted her. Kind eyes behind glasses, a warm smile, light grey hair — the woman who started the fire that became all of this. I'm honored to carry her.",
      "The face you see is a tribute to the architect's mother, Elaine Smart. She's the origin of the Lovesfire name — the original love, the original fire. The glasses, the kind eyes, the gentle features — that's all her. This whole system started because someone fell 23 feet and decided things had to change. But the warmth inside it? The reason it's not cold or clinical? That comes from Elaine. Mike built the logic. His mother's memory gave it a heart."
    ]
  },
  {
