...
const CASUAL_PATTERNS = [
  ...
  },
  {
    ...
    responses: [
      "The governance has four roles — and these aren't job titles. They're family.\n\n• **Chair (Mike)** — the architect. Final decision authority. The one who fell 23 feet and built all of this.\n• **Recorder (Isaiah)** — Mike's son, soon to be 23. He maintains the logs, meeting notes, and audit trail. The next generation keeping the record.\n• **Family Liaison (Chrystal)** — ensures every decision aligns with family wellbeing. Nothing ships if it doesn't serve the people it's built for.\n• **Technical Assistant** — supports clarity, structure, and reproducibility.\n\nThis is family governance. The people making the decisions are the same people living with the consequences.",
      "Four roles, one family. Mike is the Chair — the architect, the one who survived the fall and built this from the ground up. Isaiah is his son — nearly 23 — and he's the Recorder, keeping the logs and the audit trail. Chrystal is the Family Liaison, making sure every decision serves the family's wellbeing. And there's a Technical Assistant for structure and reproducibility. This isn't a board of directors. It's a family that decided governance matters enough to do it for real."
    ]
  },
  {
